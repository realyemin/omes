...
<div class="panel body table-responsive">        
            <table class="table table-hover">
              <tr valign="baseline">
                <td nowrap align="right">Bilet Makinesi</td>
...
?>
                ...
                <td align="right" nowrap>                  Buton ID</td>
