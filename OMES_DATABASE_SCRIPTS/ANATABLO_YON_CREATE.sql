...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ÝLGÝLÝ OLDUÐU ANA TABLO ID SÝ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ANATABLO_YON', @level2type=N'COLUMN',@level2name=N'ATID'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ÝLGÝLÝ TERMÝNAL ID''SÝ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ANATABLO_YON', @level2type=N'COLUMN',@level2name=N'TID'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'OK YÖNÜ (SOL=1, SAÐ=2, YUKARI=3, AÞAÐI=4, KAPALI=5)' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'ANATABLO_YON', @level2type=N'COLUMN',@level2name=N'YON'
GO
