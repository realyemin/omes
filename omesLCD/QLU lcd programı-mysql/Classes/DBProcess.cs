    ...
    internal class DBProcess
    {
        public class Settings
        {
            ...
            private static string CreateConString()
            {
                ...
                string DataSource = QLU.Properties.Settings.Default.ServerIP; // + "\\SQLEXPRESS";
                string DbName = QLU.Properties.Settings.Default.dbName;
                string DBUserName = QLU.Properties.Settings.Default.dbUserName;
                string DBPass = QLU.Properties.Settings.Default.dbPassword;
        ...
        public static Hashtable InsertDataChecked(string TableName, Hashtable ColumnsValues, string Where,
        ...
        public static Hashtable InsertCheckedUpdate(string TableName, Hashtable ColumnsValues, string Where,
            string IdentityColumn)
        {
            Hashtable rHt = new Hashtable();
            try
