    ...
    class DBProcess
    {
        public class Settings
        {
            ...
            private static string CreateConString()
            {
                ...
                string DataSource = QVU.Properties.Settings.Default.DataSource;
                string DbName = QVU.Properties.Settings.Default.DbName;
                string DBUserName = QVU.Properties.Settings.Default.DBUserName;
                string DBPass = QVU.Properties.Settings.Default.DBPass;
