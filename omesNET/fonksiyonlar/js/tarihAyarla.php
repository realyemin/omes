...
-- ============================================= 
 */
$row_RandevuAyar = $db->query("SELECT randevuSecimi,minimumTarihSayisi,minimumTarihTuru,maksimumTarihSayisi,maksimumTarihTuru,takvimAnimasyon,animasyonHizi FROM RANDEVU_AYAR WHERE GRPID='$randevuAyarID'")->fetch();
$tarihDizisi="";
...
case 2: //hem hafta sonu hem de hafta içi seçili günlerde randevuyu engelle
 ?>
	 var disabledSpecificDays = [<?php echo $tarihDizisi; ?>]; 
