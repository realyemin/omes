...
<table id="tableID" class="table table-hover">
              ...
              <tr valign="baseline">
                ...
                <td><a class="btn btn-info" href="?AnaButonGuncelle&BTNID=<?php echo $_GET['BTNID']; ?>&BM_ADRES=<?php echo $_GET['BM_ADRES']; ?>">Güncelleştir Sayfasına Git</a> <a class="btn btn-danger" onclick="return confirm('Silmek istediğinizden emin misiniz');" href="?AnaButonSil&BTNID=<?php echo $_GET['BTNID']; ?>&BM_ADRES=<?php echo $_GET['BM_ADRES']; ?>">Kaydı Sil</a>
