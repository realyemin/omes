...
$row_Grup = $db->query("SELECT GRPID, GRUP_ISMI FROM GRUPLAR")->fetchAll();
$BM_ADRES = "-1";
$BTNID = "-1";
...
<div class="form-group">
  <div class="panel panel-pink">
    <div class="panel panel-heading">Alt Buton Detay Ekranı</div>
<div class="row">
<div class="col-md-6">
...
<table class="table table-hover">
			...
			$row_BiletMakinesi =$db->query("SELECT MAKINE_ADI FROM BILET_MAKINELERI WHERE MAKINE_ADRESI = '$row_Butonlar[BM_ADRES]'")->fetch();

echo $row_BiletMakinesi['MAKINE_ADI'];
?></td>
                <th align="right" nowrap>Ana Buton ID: <span class="label label-default"><?php echo htmlentities($row_Butonlar['ANA_BTNID'], ENT_COMPAT, 'utf-8'); ?></span></th>
                <td>Alt Buton ID
              ...
              <tr valign="baseline">
                ...
                <td> 
                  <?php 
$row_Grup =$db->query("SELECT GRUP_ISMI FROM GRUPLAR WHERE GRPID='$row_Butonlar[GRP_ID]'")->fetch();					  				  
                ...
                <tr valign="baseline">
                  ...
                  <td><?php 
$row_Grup =$db->query("SELECT GRUP_ISMI FROM GRUPLAR WHERE GRPID='$row_Butonlar[GRP_ID2]'")->fetch();				  				  
                ...
                <tr valign="baseline">
                  ...
                  <td><?php 
$row_Grup =$db->query("SELECT GRUP_ISMI FROM GRUPLAR WHERE GRPID='$row_Butonlar[GRP_ID3]'")->fetch();		  				  
                ...
                <tr valign="baseline">
                  ...
                  <td><?php 
$row_Grup =$db->query("SELECT GRUP_ISMI FROM GRUPLAR WHERE GRPID='$row_Butonlar[GRP_ID4]'")->fetch();				  				  
...
<div class="panel body table-responsive">
 <table id="tableID" class="table table-hover">
              ...
              <tr valign="baseline">
                ...
                <td>
                  <input disabled class="jscolor form-control"  type="text" name="RENK" value="<?php echo htmlentities($row_Butonlar['RENK'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
              </tr>
              <tr valign="baseline">
                <th nowrap align="right">Yazı Rengi::</th>
                <td><input disabled class="jscolor form-control" type="text" name="YAZI_RENGI" value="<?php echo htmlentities($row_Butonlar['YAZI_RENGI'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
              </tr>
              <tr valign="baseline">
              ...
              <tr valign="baseline">
                ...
                <td><a class="btn btn-info" href="?AltButonGuncelle&BTNID=<?php echo $row_Butonlar['BTNID'] ?>&BM_ADRES=<?php echo $row_Butonlar['BM_ADRES'] ?>">Güncelleştir Sayfasına Git</a> <a class="btn btn-danger" onclick="return confirm('Silmek istediğinizden emin misiniz');" href="?AltButonSil&BTNID=<?php echo $row_Butonlar['BTNID'] ?>&BM_ADRES=<?php echo $row_Butonlar['BM_ADRES'] ?>">Kaydı Sil</a>
